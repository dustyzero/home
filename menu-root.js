...
console.log("Logged for Menu; Dark mode " + $.urlParam('darkmode') + "!"); 
if ($.urlParam('darkmode') == "on") {
    ...
    document.write('<li><a href="news/topics/index.html?darkmode=on">News Navigator</a></li>');
    document.write('</br>');
    ...
    document.write('<li><a href="news/topics/index.html">News Navigator</a></li>');
    document.write('</br>');
